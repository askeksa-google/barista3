...
class ChipThemeData with Diagnosticable {
  ...
  static BorderSide? _lerpSides(BorderSide? a, BorderSide? b, double t) {
    ...
    if (b == null)
      return BorderSide.lerp(
          BorderSide(width: 0, color: a.color.withAlpha(0)), a, t);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorProperty('deleteIconColor', deleteIconColor,
    ...
    properties.add(ColorProperty('selectedShadowColor', selectedShadowColor,
        defaultValue: defaultData.selectedShadowColor));
    properties.add(ColorProperty('checkMarkColor', checkmarkColor,
