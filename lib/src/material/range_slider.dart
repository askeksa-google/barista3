...
class _RangeSliderState extends State<RangeSlider>
  ...
  Widget build(BuildContext context) {
    ...
    const RangeSliderTrackShape _defaultTrackShape =
        RoundedRectRangeSliderTrackShape();
    const RangeSliderTickMarkShape _defaultTickMarkShape =
        RoundRangeSliderTickMarkShape();
    const SliderComponentShape _defaultOverlayShape = RoundSliderOverlayShape();
    const RangeSliderThumbShape _defaultThumbShape =
        RoundRangeSliderThumbShape();
    const RangeSliderValueIndicatorShape _defaultValueIndicatorShape =
