...
export 'package:flute/services.dart'
    show
        TextInputType,
        TextInputAction,
        TextCapitalization,
...
class CupertinoTextField extends StatefulWidget {
  ...
  const CupertinoTextField({
    ...
    this.restorationId,
        ...
        assert(
            obscuringCharacter != null /* && obscuringCharacter.length == 1*/),
...
class _CupertinoTextFieldState extends State<CupertinoTextField>
  ...
  Widget build(BuildContext context) {
    ...
    final TextSelectionControls textSelectionControls =
        widget.selectionControls ?? cupertinoTextSelectionControls;
    ...
    final Color cursorColor =
        CupertinoDynamicColor.maybeResolve(widget.cursorColor, context) ??
