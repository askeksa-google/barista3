...
void _invoke1<A>(void Function(A a)? callback, A arg) {
  if (callback == null) {
    return;
  }
...
/// the callback (and thus passed to this function, in addition to the
/// callback itself and the zone in which the callback is executed).
void _invoke2<A1, A2>(void Function(A1 a1, A2 a2)? callback, A1 arg1, A2 arg2) {
  if (callback == null) {
    return;
  }
...
void _invoke3<A1, A2, A3>(
    void Function(A1 a1, A2 a2, A3 a3)? callback, A1 arg1, A2 arg2, A3 arg3) {
  if (callback == null) {
    return;
  }
